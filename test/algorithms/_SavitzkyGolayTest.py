...
from wai.ma.algorithms import SavitzkyGolay

from ..test import Tags
from ._MatrixAlgorithmTest import MatrixAlgorithmTest


class SavitzkyGolayTest(MatrixAlgorithmTest):
    @classmethod
    def subject_type(cls):
        return SavitzkyGolay

    @RegressionTest
    def coefficients_3_3_2_0(self, subject: SavitzkyGolay, *resources: Matrix):
        self.coefficient_helper(subject, 3, 3, 2, 0)
        return self.standard_regression(subject, *resources)

    @RegressionTest
    def coefficients_3_3_2_1(self, subject: SavitzkyGolay, *resources: Matrix):
        self.coefficient_helper(subject, 3, 3, 2, 1)
        return self.standard_regression(subject, *resources)

    @RegressionTest
    def coefficients_3_3_2_2(self, subject: SavitzkyGolay, *resources: Matrix):
        self.coefficient_helper(subject, 3, 3, 2, 2)
        return self.standard_regression(subject, *resources)

    @RegressionTest
    def coefficients_0_3_2_1(self, subject: SavitzkyGolay, *resources: Matrix):
        self.coefficient_helper(subject, 0, 3, 2, 1)
        return self.standard_regression(subject, *resources)

    @RegressionTest
    def coefficients_3_0_2_1(self, subject: SavitzkyGolay, *resources: Matrix):
